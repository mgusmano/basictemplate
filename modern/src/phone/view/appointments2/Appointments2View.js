	...
	items: [
		{
			...
			<div class="testview" style="width: 100%;border: 0px solid green;">
				...
				<tr>
					...
					<tpl if="this.getFont(AptAttendanceIndicator)">
					Attend: <div class="action action-{AptAttendanceIndicator} fa fa-thumbs-up"></div>
					<tpl else>
					Attend: <div class="action action-{AptAttendanceIndicator} fa fa-thumbs-down"></div>
					</tpl>
					</td>
					</tr>
			...
			// 		<br/>Appt Number: {ApptNumber} 
			// 		<br/>Hospital: {ApptHospitalName}
			// 		<br/>醫院: {AppointmentHospitalChineseName}
			// 		<br/>Speciality: {AppointmentSpeciality}
			// 		<br/>Start: {AptStartDtm}
			// 		<br/>End: {AptEndDtm}
			// 		<br/>Attendance: {AptAttendanceIndicator}
			// 		<br/>Arrival: {AptArrivalDtm}
			// 		<br/>Completion: {AptCompleteDtm}
			...
			// <div class="action action-{AptAttendanceIndicator} fa fa-thumbs-{[this.getFont(values.AptAttendanceIndicator)]}></div>
			
			// {AptAttendanceIndicator}
			// {[this.getFont(values.AptAttendanceIndicator)]}
			//{ApptNumber} {[this.getFont(values.AptAttendanceIndicator))]}
